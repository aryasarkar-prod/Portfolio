    ...
    <SectionWrapper id="projects">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Things I've built, shipped, and am proud of"
            ...
            <motion.button
              ...
              className={`px-5 py-2 rounded-xl text-sm font-semibold transition-all border ${
                activeCategory === cat
                  ...
                  : 'bg-white/5 border-white/10 text-gray-400 hover:text-white hover:border-blue-500/30'
              }`}
            >
              {cat}
            </motion.button>
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden flex-shrink-0">
                    <img
                      ...
                      onError={e => {
                        ...
                        el.parentElement!.innerHTML = `
                          <div class="w-full h-full bg-gradient-to-br ${gradients[i % gradients.length]} flex items-center justify-center">
                            <span class="text-5xl">${project.title[0]}</span>
                          </div>`;
                      }}
                    />
                    ...
                    {/* Featured badge */}
                    {project.featured && (
                      <div className="absolute top-3 left-3 px-2 py-1 rounded-lg bg-yellow-500/90 text-yellow-900 text-xs font-bold flex items-center gap-1">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <h3 className="text-white font-bold text-base mb-2 line-clamp-1">{project.title}</h3>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      ...
                      {project.tags.length > 4 && (
                        <span className="text-xs text-gray-500 px-2 py-1">+{project.tags.length - 4}</span>
                      )}
                    </div>
                    ...
                    <div className="flex gap-3 pt-3 border-t border-white/5">
                      ...
                      {project.live && (
                        <a
                          ...
                          rel="noopener noreferrer"
                          onClick={e => e.stopPropagation()}
                          className="flex items-center gap-1.5 text-sm text-blue-400 hover:text-blue-300 transition-colors ml-auto"
                        >
        ...
        {filtered.length > 6 && (
          <div className="text-center mt-10">
            <motion.button
              ...
              className="px-8 py-3 rounded-xl border border-white/10 text-gray-300 hover:text-white hover:border-blue-500/30 hover:bg-blue-500/5 transition-all text-sm font-semibold"
            >
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <span className="px-3 py-1 rounded-xl bg-blue-500/10 text-blue-400 text-sm font-medium border border-blue-500/20 flex-shrink-0">
                ...
                <div className="flex gap-4 pt-4 border-t border-white/5">
                  {selectedProject.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:border-blue-500/30 transition-all text-sm font-medium"
                    >
